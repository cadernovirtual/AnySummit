...
<nav class="sidebar">
    <div class="menu-item <?php echo $checkin_active; ?>" onclick="window.location.href='/participante/checkin'">
        <span class="menu-icon">📱</span>
        <span>Fazer Conexão</span>
    </div>
    <div class="menu-item <?php echo $realizados_active; ?>" onclick="window.location.href='/participante/conexao'">
        <span class="menu-icon">👤</span>
        <span>Minhas Conexões</span>
    </div>
    
   
    <div class="menu-item <?php echo $msg_personalizada_active; ?>" onclick="window.location.href='/participante/msg-personalizada'">
        <span class="menu-icon">💬</span>
        <span>Mensagem Personalizada</span>
    </div>
 
    
    <div class="menu-item <?php echo $config_active; ?>" onclick="window.location.href='/participante/config'">
...
function logout() {
    if (confirm('Tem certeza que deseja sair?')) {
        window.location = '/participante/logout.php';
    }
}
