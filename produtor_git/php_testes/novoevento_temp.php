        ...
        <script language='javascript' src="/produtor/js/wizard-fix.js"></script>
        <script language='javascript' src="/produtor/js/preview-fix.js"></script>
        <script language='javascript' src="/produtor/js/wizard-fix-definitivo.js"></script>
