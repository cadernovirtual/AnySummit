...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Verificar se acabou de voltar do WhatsApp
    if (localStorage.getItem('justProcessed') === 'true') {
        localStorage.removeItem('justProcessed');
        // Garante que a interface está limpa
        resetApp();
    }
        ...
        if (isScanning) {
            ...
            const qrCodeSuccessCallback = async (decodedText, decodedResult) => {
                ...
                try {
                    ...
                    if (response.link) {
                        // Se retornou um link, redirecionar
                        showWhatsappRedirect('Redirecionando para WhatsApp...');
                        
                        // Marcar que acabou de processar para limpar quando voltar
                        localStorage.setItem('justProcessed', 'true');
                        
                        // Reset visual antes de sair
                        setTimeout(() => {
                            resetApp();
                            // Redirecionar substituindo a página atual  
