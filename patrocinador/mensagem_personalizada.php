...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/patrocinador/css/checkin-painel-1-0-1-msg.css">
</head>
<body>
                    ...
                    <form id="messageForm" onSubmit="salvarMensagem(event)">
                        ...
                        <div class="variables-info">
                            ...
                            <div class="variables-list">
                                ...
                                <div class="variable-item">
                                    <code>{{MeuNome}}</code>
                                    <span>→ Seu nome (quem está fazendo a conexão)</span>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        document.getElementById('mensagem').addEventListener('input', function() {
            ...
            previewText = previewText.replace(/{{MeuNome}}/g, '<strong>Maria Santos</strong>');
