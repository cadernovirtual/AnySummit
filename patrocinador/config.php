...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/patrocinador/css/checkin-painel-1-0-1-config2.css">
</head>
<body>
                        ...
                        <div class="photo-section">
                            ...
                            <div class="photo-upload-container">
                                <div class="current-photo">
                                    <img id="photoPreview" 
                                         src="<?php echo !empty($dados_participante['thumb']) ? '../uploads/foto/' . $dados_participante['thumb'] : 'https://anysummit.com.br/patrocinador/img/user.jpg'; ?>" 
                                         alt="Foto atual" 
