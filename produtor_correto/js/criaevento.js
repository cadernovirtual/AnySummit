...
(function() {
    ...
    let currentStep = 1;
        ...
        // FunÁ„o auxiliar para retornar o SVG do Ìcone de lixeira
        ...
        // FunÁ„o para navegar entre steps
        ...
        function validateStep(stepNumber) {
            ...
            switch(stepNumber) {
                ...
                case 2:
                    ...
                    if (!classification || classification.value === '') {
                        ...
                        camposInvalidos.push('ClassificaÁ„o');
                        isValid = false;
                    }
                ...
                case 5:
                    // Validar se h· pelo menos um lote cadastrado
            ...
            // Mostrar ou esconder mensagem de validaÁ„o
            if (!isValid && validationMessage) {
                validationMessage.textContent = 'Todos os campos obrigatÛrios precisam ser preenchidos!';
            ...
            console.log('? Resultado da validaÁ„o do step', stepNumber, ':', isValid);
            return isValid;
        }

        // FunÁıes antigas comentadas - agora definidas diretamente no window
        /*
        function nextStep() {
        ...
        */
        ...
        async function publishEvent() {
            if (validateStep(currentStep)) {
                ...
                // Chamar a funÁ„o de envio para API
        ...
        // Expor funÁ„o publishEvent globalmente
        ...
        function initMap() {
            ...
            try {
                ...
                mapElement.innerHTML = '<div class="map-loading">Mapa carregado - Pesquise um endereÁo acima</div>';
        ...
        // Todas as outras funÁ√µes do arquivo original...
        // [Incluir todas as funÁ√µes JavaScript do arquivo original aqui]

        // InicializaÁ„o quando DOM estiver pronto
        document.addEventListener('DOMContentLoaded', function() {
            ...
            try {
                ...
                */
                ...
                console.log('üîç Bot„o combo encontrado:', comboBtn);
                if (comboBtn) {
                    console.log('‚úÖ Event listener adicionado ao bot„o combo');
                } else {
                    console.error('‚ùå Bot„o combo N√ÉO encontrado!');
                }
                
            } catch (error) {
                console.error('‚ùå Erro na inicializaÁ„o:', error);
            }
        });

        // [Incluir todas as demais funÁ√µes JavaScript do arquivo original aqui]
        // Copie todas as funÁ√µes do arquivo original, incluindo:
        // - initAddressSearch()
        // - searchAddresses()
        // - selectAddress()
        // - updatePreview()
        ...
        // FunÁ„o initImageUpload - DESATIVADA (substituÌda por fundoUpload)
        ...
        function initAdditionalUploads() {
            ...
            if (fundoUpload) {
                fundoUpload.addEventListener('change', function() {
                    // Verificar se È o preview principal ou o container pequeno
        ...
        // FunÁ„o para processar upload de imagens adicionais
        ...
        // FunÁ„o para processar upload da imagem principal de fundo
        async function handleMainImageUpload(input, containerId, type) {
            ...
            reader.onload = function(e) {
                ...
                if (container) {
                    ...
                    // Atualizar tambÈm o imagePreview para compatibilidade
        ...
        // FunÁ„o para limpar imagem e remover arquivo
        function clearImage(type, event) {
            // Prevenir propagaÁ„o do clique
            if (event) {
            ...
            switch(type) {
                case 'logo':
                    ...
                    defaultContent = `
                        ...
                        <div class="upload-hint">800x200px ï Fundo transparente</div>
                    `;
                    break;
                case 'capa':
                    ...
                    defaultContent = `
                        ...
                        <div class="upload-hint">450x450px ï Fundo transparente</div>
                    `;
                    break;
                case 'fundo':
                    ...
                    defaultContent = `
                        ...
                        <div class="upload-hint">PNG, JPG atÈ 5MB ï Tamanho ideal: 1920x640px</div>
                    `;
                    break;
            }
        ...
        function initTicketManagement() {
            ...
            if (addPaidBtn) {
                addPaidBtn.addEventListener('click', function() {
                    ...
                    // Carregar lotes apÛs abrir o modal
                    setTimeout(function() {
                        if (typeof carregarLotesIngressoPago === 'function') {
                            ...
                            console.error('FunÁ„o para carregar lotes n„o encontrada');
                        }
                        
                        // Calcular valores do ingresso
                        if (typeof calcularValoresIngresso === 'function') {
                            // Limpar campo de preÁo
                ...
                addFreeBtn.addEventListener('click', function() {
                    ...
                    setTimeout(function() {
                        ...
                        if (typeof carregarLotesNoModalFree === 'function') {
                            ...
                            console.log('FunÁ„o carregarLotesNoModalFree executada');
                        } else {
                            console.error('FunÁ„o carregarLotesNoModalFree n„o encontrada');
                            // Tentar alternativa
                            if (typeof window.carregarLotesNoModalFree === 'function') {
                                window.carregarLotesNoModalFree();
                                console.log('FunÁ„o window.carregarLotesNoModalFree executada');
                            }
                        }
                    }, 300);
                });
        ...
        function createPaidTicket() {
            ...
            // ValidaÁ„o com destaque de campos
            let hasError = false;
            ...
            if (hasError) {
                alert('Por favor, preencha todos os campos obrigatÛrios marcados em vermelho.');
                return;
            }

            // Verificar se estamos em modo de ediÁ„o (existe API) ou criaÁ„o
            if (window.location.pathname.includes('editar-evento.php')) {
                // Modo ediÁ„o - usar API
                ...
                .catch(error => {
                    console.error('‚ùå Erro na requisiÁ„o:', error);
                    alert('Erro ao criar ingresso. Tente novamente.');
                });
            } else {
                // Modo criaÁ„o - usar sistema de ingressos tempor·rios
                const cleanPrice = parseFloat(price.replace(/[R$\s\.]/g, '').replace(',', '.'));
                const cleanTaxa = parseFloat(taxaValor.replace(/[R$\s\.]/g, '').replace(',', '.'));
                const cleanValorReceber = parseFloat(valorReceber.replace(/[R$\s\.]/g, '').replace(',', '.'));
        ...
        function createFreeTicket() {
            ...
            if (!title || !quantity) {
                alert('Por favor, preencha todos os campos obrigatÛrios.');
                return;
            }

            // Verificar se estamos em modo de ediÁ„o (existe API)
            if (window.location.pathname.includes('editar-evento.php') && typeof fetch !== 'undefined') {
                ...
                if (typeof addTicketToCreationList === 'function') {
                    ...
                    // Fallback para funÁ„o antiga com par‚metros adicionais
        ...
        function updatePreview() {
            ...
            // Mostrar descriÁ„o apenas se existir, caso contr·rio deixar vazio
            if (previewDescription) {
                previewDescription.textContent = description ? description.substring(0, 120) : '';
            }
            
            // Mostrar data de inÌcio e fim
            if (startDateTime && previewDate) {
                ...
                if (endDateTime) {
                    ...
                    dateText += ' atÈ ' + endDateObj.toLocaleDateString('pt-BR', {
                        day: '2-digit',
                        month: '2-digit',
                        year: 'numeric',
                        hour: '2-digit',
        ...
        // FunÁ„o para atualizar o preview hero
        ...
        function clearAllWizardData() {
            ...
            // Limpar lotes usando a funÁ„o global
            if (window.limparTodosLotes) {
                window.limparTodosLotes();
            }
            
            // Limpar tambÈm ingressos tempor·rios
        ...
        // FunÁ„o para coletar ingressos da lista visual
        ...
        // FunÁ„o para salvar dados do wizard
        function saveWizardData() {
            // Debug - verificar qual elemento est· sendo capturado
            const eventNameElement = document.getElementById('eventName');
            console.log('Salvando dados do wizard...');
            
            // Coletar dados de endereÁo completo
            ...
            loteCards.forEach((card, index) => {
                const loteData = {
                    ...
                    dataInicio: card.querySelector('.lote-info span:nth-child(1)')?.textContent?.replace('InÌcio: ', '') || '',
            ...
            // Salvar lotes separadamente tambÈm
        ...
        // FunÁ„o para verificar e restaurar dados do wizard
        function checkAndRestoreWizardData() {
            console.log('=== INICIANDO checkAndRestoreWizardData ===');
            console.log('Cookies disponÌveis:', document.cookie);
            ...
            if (savedData) {
                ...
                try {
                    ...
                    if (window.customDialog && window.customDialog.wizardRestore) {
                        console.log('Usando customDialog para perguntar ao usu·rio...');
                        window.customDialog.wizardRestore(eventName).then(action => {
                            console.log('Resposta do usu·rio:', action);
                            if (action === 'continue') {
                                restoreWizardData(data);
                            } else {
                                // Limpar dados se usu·rio n„o quiser restaurar
                                clearAllWizardData();
                            }
                        });
                    } else {
                        console.log('customDialog n„o disponÌvel, usando confirm nativo');
                        // Fallback para confirm nativo se dialog n„o estiver disponÌvel
                        const shouldRestore = confirm(`VocÍ deseja continuar a configuraÁ„o do evento "${eventName}" do ponto onde parou?`);
        ...
        // FunÁ„o para restaurar dados do wizard
        function restoreWizardData(data) {
            ...
            // Restaurar switch de localizaÁ„o
            ...
            // Restaurar lotes
            if (data.lotes) {
                // Salvar lotes no cookie para que o mÛdulo de lotes possa carregar
                setCookie('lotesData', JSON.stringify(data.lotes), 7);
                // Chamar funÁ„o para carregar lotes
            ...
            if (data.tickets && data.tickets.length > 0) {
                ...
                // Restaurar cada ingresso usando as funÁıes de criaÁ„o
                        ...
                        ticketItem.innerHTML = `
                            <div class="ticket-header">
                                ...
                                <div class="ticket-pricing">
                                    ...
                                    <div class="ticket-price-item">
                                        <span class="ticket-price-label">VocÍ recebe:</span>
        ...
        function initPreviewListeners() {
            ...
            // Adicionar listener para descriÁ„o tambÈm
            const eventDescription = document.getElementById('eventDescription');
            if (eventDescription) {
                ...
                // TambÈm salvar ao perder o foco
        ...
        // [Incluir todas as demais funÁ√µes necess·rias do arquivo original]
        ...
        // [Incluir todas as funÁ√µes da API do arquivo original]
        ...
        // [Incluir todas as demais funÁ√µes necess·rias...]
        ...
        async function enviarEventoParaAPI() {
            try {
                ...
                if (!validacao.valido) {
                    alert('Erro de validaÁ„o:\n' + validacao.erros.join('\n'));
                    return false;
                }
                
                // 3. Debug - ver dados que ser„o enviados
                console.log('üìã Dados completos:', dados);
                console.log('üìã Ingressos especÌficos:', dados.ingressos);
                
                // 4. Enviar TUDO para o PHP com configuraÁ„o correta
                ...
                // 5. Verificar se a resposta È JSON v·lida
                let resultado;
                try {
                    resultado = await response.json();
                } catch (jsonError) {
                    const textResponse = await response.text();
                    console.error('‚ùå Resposta n„o È JSON v·lida:', textResponse);
        ...
        function validarDadosObrigatorios(dados) {
            ...
            if (!dados.evento.nome || dados.evento.nome.trim() === '') {
                erros.push('Nome do evento È obrigatÛrio');
            }
            
            // Validar data de inÌcio
            if (!dados.evento.data_inicio) {
                erros.push('Data e hora de inÌcio s„o obrigatÛrias');
            }
            
            // Validar localizaÁ„o
            if (dados.evento.tipo_local === 'presencial') {
                if (!dados.evento.busca_endereco || dados.evento.busca_endereco.trim() === '') {
                    erros.push('EndereÁo È obrigatÛrio para eventos presenciais');
                }
            } else if (dados.evento.tipo_local === 'online') {
                if (!dados.evento.link_online || dados.evento.link_online.trim() === '') {
                    erros.push('Link do evento È obrigatÛrio para eventos online');
                }
            }
            ...
            return new Promise((resolve) => {
                ...
                switch(elementId) {
                    ...
                    case 'fundo':
                        ...
                        break;
                    default:
                        // Para compatibilidade com cÛdigo antigo
        ...
        function coletarDadosFormulario() {
            ...
            const localizacao = {
                ...
                busca_endereco: (function() {
                    // Construir endereÁo completo a partir dos campos
        ...
        function coletarDadosIngressos() {
            ...
            ticketItems.forEach((item, index) => {
                ...
                } else if (buyerPriceText.includes('cÛdigo') || ticketName.toLowerCase().includes('cÛdigo')) {
                    tipo = 'codigo';
                }
                ...
                console.log(`??ù Ingresso ${index + 1}:`, ingresso);
        ...
        function initFormSubmission() {
            // J· est· implementada no cÛdigo acima, n„o precisa duplicar
        }
        ...
        function initAddressSearch() {
            ...
            console.log('üîç Inicializando busca de endereÁos...');
            ...
            console.log('‚úÖ Busca de endereÁos inicializada');
        }

        function searchAddresses(query) {
            console.log('üîç Buscando endereÁos para:', query);
            ...
            if (typeof google !== 'undefined' && google.maps && google.maps.places && autocompleteService) {
                ...
                autocompleteService.getPlacePredictions(request, function(predictions, status) {
                    ...
                    if (status === google.maps.places.PlacesServiceStatus.OK && predictions && predictions.length > 0) {
                        ...
                        console.log('‚ö†Ô∏è Sem resultados da API, usando simulaÁ„o');
                        simulateAddressSearch(query);
                    }
                });
            } else {
                console.log('‚ö†Ô∏è Google Places API n„o disponÌvel, usando simulaÁ„o');
                simulateAddressSearch(query);
            }
        }
        ...
        function selectAddress(address) {
            console.log('??ç EndereÁo selecionado:', address.description);
            ...
            if (address.place_id.startsWith('mock_')) {
                ...
                console.log('‚ö†Ô∏è API n„o disponÌvel, usando simulaÁ„o');
        ...
        function getPlaceDetails(placeId) {
            ...
            placesService.getDetails(request, function(place, status) {
                ...
                if (status === google.maps.places.PlacesServiceStatus.OK && place) {
                    ...
                    console.log('‚ùå Erro ao obter detalhes, usando simulaÁ„o');
        ...
        function fillAddressFields(place) {
            console.log('??ù Preenchendo campos com dados da API');
        ...
        function updateMapLocation(location) {
            if (!map || !location) {
                console.log('‚ö†Ô∏è Mapa ou localizaÁ„o n„o disponÌvel');
                return;
            }
        ...
        function addTicketToList(type, title, quantity, price, loteId = '', description = '', saleStart = '', saleEnd = '', minQuantity = 1, maxQuantity = 5) {
            ...
            ticketItem.innerHTML = `
                ...
                <div class="ticket-details">
                    <div class="ticket-info">
                        ...
                        ${type === 'paid' ? `<span>PreÁo: <strong>${buyerPrice}</strong></span>` : ''}
            ...
            // Armazenar dados do ingresso para ediÁ„o
        ...
        function removeTicket(ticketId) {
            ...
            if (verificarIngressoEmCombo(ticketId)) {
                alert('N„o È possÌvel excluir este ingresso pois ele est· sendo usado em um combo. Remova-o do combo primeiro.');
                return;
            }
            ...
            if (confirm('Tem certeza que deseja excluir este ingresso?')) {
                ...
                if (ticketElement) {
                    ...
                    // Remover tambÈm de temporaryTickets se existir
        ...
        // FunÁ„o para verificar se ingresso est· em combo
        ...
        function createCodeTicket() {
            ...
            if (quantity > 1000) {
                alert('M·ximo de 1000 cÛdigos permitidos.');
                return;
            }
            ...
            ticketItem.innerHTML = `
                <div class="ticket-header">
                    <div class="ticket-info">
                        ...
                        <div class="ticket-buyer-price">Valor do comprador: <strong>Acesso via cÛdigo</strong></div>
                        <div class="ticket-receive-amount">Tipo: <strong>CÛdigos de acesso</strong></div>
                    </div>
                    <div class="ticket-actions-inline">
                        <div class="switch-mini active" title="Ativar/Desativar">
                            <div class="switch-mini-handle"></div>
                        </div>
                        <button class="btn-icon btn-codes" title="Listar CÛdigos" onclick="openCodesModal('${ticketId}')">
                            ??
                        </button>                       
                ...
                <div class="ticket-details-list">
                    <div class="ticket-detail-item">
                        <div class="ticket-detail-label">CÛdigos Gerados</div>
                        <div class="ticket-detail-value">${quantity}</div>
                    </div>
                    <div class="ticket-detail-item">
                        <div class="ticket-detail-label">CÛdigos Usados</div>
            ...
            codes.forEach((codeData, index) => {
                ...
                row.innerHTML = `
                    <td>
                        ...
                        <button class="btn btn-outline btn-small" onclick="copyIndividualCode('${codeData.code}')" title="Copiar cÛdigo" style="margin-left: 8px; padding: 2px 6px; font-size: 0.7rem;">
                            ??
                        </button>
                    </td>
                    <td>
        ...
        function shareCodeWhatsApp(code, index) {
            ...
            const message = `üéüÔ∏è *Seu cÛdigo de acesso*\n\n` +
                           `*Evento:* ${eventName}${dateText}\n\n` +
                           `*CÛdigo:* \`${code}\`\n\n` +
                           `??ù Apresente este cÛdigo no evento para ter acesso.\n\n` +
        ...
        function updateCodeRecipient(index, description) {
            console.log(`CÛdigo ${index} foi encaminhado para: ${description}`);
        }

        function copyIndividualCode(code) {
            navigator.clipboard.writeText(code).then(() => {
                const notification = document.createElement('div');
                notification.textContent = 'CÛdigo copiado!';
                notification.style.cssText = `
                    position: fixed;
                    top: 20px;
                    right: 20px;
        ...
        function deleteCode(index) {
            if (confirm('Tem certeza que deseja apagar este cÛdigo?')) {
        ...
        function copyAllCodes() {
            ...
            navigator.clipboard.writeText(codes).then(() => {
                alert('Todos os cÛdigos foram copiados para a ·rea de transfer√™ncia!');
            });
        }
        ...
        // FUN«√O ANTIGA - SUBSTITUÕDA POR populateComboTicketSelectByLote
        function populateComboTicketSelect() {
            // N„o fazer nada - usar populateComboTicketSelectByLote
            console.log('populateComboTicketSelect chamada - redirecionando para nova funÁ„o');
        }
    ...
    ???
        ...
        function createComboTicket() {
            ...
            if (comboItems.length === 0) {
                ...
                // Destacar a ·rea de composiÁ„o do combo
            ...
            // Obter informaÁıes do lote selecionado
            const selectLote = document.getElementById('comboTicketLote');
        ...
        function addComboToList(title, quantity, price, comboData, totalItems, description, loteId, loteNome, startDate, endDate) {
            ...
            ticketItem.innerHTML = `
                <div class="ticket-header">
                    <div class="ticket-title">
                        ...
                        <span class="ticket-lote-info" style="font-size: 11px; color: #666; margin-left: 10px;">
                            ${loteNome} - Por Data (${formatDate(startDate)} atÈ ${formatDate(endDate)})
                        </span>
                    </div>
                    <div class="ticket-actions">
                ...
                <div class="ticket-details">
                    <div class="ticket-info">
                        <span>Quantidade: <strong>${quantity}</strong></span>
                        <span>PreÁo: <strong>${price}</strong></span>
                        <span>Taxa: <strong>${taxFormatted}</strong></span>
                        <span>VocÍ recebe: <strong>${receiveFormatted}</strong></span>
                    </div>
            ...
            // Armazenar dados do combo para ediÁ„o
            ticketItem.ticketData = {
                type: 'combo',
                title: title,
                quantity: quantity,
        ...
        // Inicializar formataÁ„o de preÁo para combo
...
// FunÁ„o para editar ingresso existente
function editTicket(ticketId) {
    ...
    // Verificar se È pago ou gratuito
...
// FunÁ„o para extrair dados do ingresso do elemento HTML
function extractTicketDataFromElement(element) {
    ...
    return {
        ...
        titulo: title.replace(/\s+(Gratuito|Pago|CÛdigo)$/, ''),
        tipo: tipo,
...
// FunÁ„o para popular modal de ediÁ„o de ingresso pago
// FunÁ„o para popular modal de ediÁ„o de ingresso pago
function populateEditPaidTicketModal(ticketData) {
    console.log('üîß populateEditPaidTicketModal chamada - vers„o CORRIGIDA', ticketData);
    ...
    if (editTicketId) {
        ...
        console.error('‚ùå editTicketId n„o encontrado');
    }
    ...
    if (editPaidTicketTitle) {
        ...
        console.error('‚ùå editPaidTicketTitle n„o encontrado');
    }
    ...
    if (editPaidTicketQuantity) {
        ...
        console.error('‚ùå editPaidTicketQuantity n„o encontrado');
    }
    ...
    if (editPaidTicketPrice) {
        ...
        console.error('‚ùå editPaidTicketPrice n„o encontrado');
    }
    ...
    if (editPaidTicketReceive) {
        ...
        console.error('‚ùå editPaidTicketReceive n„o encontrado');
    }
    ...
    if (editPaidSaleStart) {
        ...
        console.error('‚ùå editPaidSaleStart n„o encontrado');
    }
    ...
    if (editPaidSaleEnd) {
        ...
        console.error('‚ùå editPaidSaleEnd n„o encontrado');
    }
    ...
    if (editPaidMinQuantity) {
        ...
        console.error('‚ùå editPaidMinQuantity n„o encontrado');
    }
    ...
    if (editPaidMaxQuantity) {
        ...
        console.error('‚ùå editPaidMaxQuantity n„o encontrado');
    }
    ...
    if (editPaidTicketDescription) {
        ...
        console.error('‚ùå editPaidTicketDescription n„o encontrado');
    }
}

// FunÁ„o para popular modal de ediÁ„o de ingresso gratuito
function populateEditFreeTicketModal(ticketData) {
    console.log('üîß populateEditFreeTicketModal chamada - vers„o CORRIGIDA', ticketData);
    ...
    if (editFreeTicketId) {
        ...
        console.error('‚ùå editFreeTicketId n„o encontrado');
    }
    ...
    if (editFreeTicketTitle) {
        ...
        console.error('‚ùå editFreeTicketTitle n„o encontrado');
    }
    ...
    if (editFreeTicketQuantity) {
        ...
        console.error('‚ùå editFreeTicketQuantity n„o encontrado');
    }
    ...
    if (editFreeSaleStart) {
        ...
        console.error('‚ùå editFreeSaleStart n„o encontrado');
    }
    ...
    if (editFreeSaleEnd) {
        ...
        console.error('‚ùå editFreeSaleEnd n„o encontrado');
    }
    ...
    if (editFreeMinLimit) {
        ...
        console.error('‚ùå editFreeMinLimit n„o encontrado');
    }
    ...
    if (editFreeMaxLimit) {
        ...
        console.error('‚ùå editFreeMaxLimit n„o encontrado');
    }
    ...
    if (editFreeTicketDescription) {
        ...
        console.error('‚ùå editFreeTicketDescription n„o encontrado');
    }
}

// FunÁ„o para atualizar ingresso pago
...
// FunÁ„o para atualizar ingresso gratuito
...
// FunÁ„o para atualizar ingresso na lista
function updateTicketInList(ticketData) {
    ...
    if (detailsElement) {
        ...
        if (ticketData.preco > 0) {
            detailsHTML += `<span>PreÁo: <strong>R$ ${ticketData.preco.toFixed(2).replace('.', ',')}</strong></span>`;
        }
...
// FunÁ„o para formatar data para exibiÁ„o
function formatDateForDisplay(dateString) {
    const date = new Date(dateString);
    return date.toLocaleDateString('pt-BR') + ' ' + date.toLocaleTimeString('pt-BR', {hour: '2-digit', minute: '2-digit'});
}

// FunÁ„o para formatar preÁo
...
// FunÁ„o para editar combo existente
...
// FunÁ„o para extrair dados do combo do elemento HTML
...
// FunÁ„o para popular modal de ediÁ„o de combo
...
// FunÁ„o para popular select de tipos de ingresso para ediÁ„o de combo
function populateEditComboTicketSelect() {
    ...
    ticketItems.forEach((item, index) => {
        ...
        if (ticketTitle && !ticketTitle.includes('??')) {
            ...
            option.textContent = ticketTitle.replace(/\s+(Gratuito|Pago|CÛdigo)$/, '');
            select.appendChild(option);
        }
    });
}

// Vari·vel para itens do combo em ediÁ„o
let editComboItems = [];

// FunÁ„o para adicionar item ao combo em ediÁ„o
...
// FunÁ„o para renderizar itens do combo em ediÁ„o
...
// FunÁ„o para remover item do combo em ediÁ„o
function removeEditComboItem(index) {
    editComboItems.splice(index, 1);
    renderEditComboItems();
}

// FunÁ„o para atualizar combo
...
// FunÁ„o para atualizar combo na lista
    ...
    if (detailsElement) {
        let detailsHTML = `
            <div class="ticket-info">
                ...
                <span>PreÁo: <strong>R$ ${comboData.preco.toFixed(2).replace('.', ',')}</strong></span>
...
// FunÁ„o para fechar modal especÌfico para ediÁ„o
...
console.log('? FunÁıes de ediÁ„o de ingressos carregadas');
...
// Expor funÁıes e vari·veis para escopo global
window.wizardState = {
    currentStep: currentStep,
    totalSteps: totalSteps
};

// FunÁıes que precisam acessar currentStep
...
window.nextStep = function() {
    ...
    if (validateStep(currentStep)) {
        if (currentStep < totalSteps) {
            ...
            updateStepDisplay();
            console.log('? AvanÁou para step:', currentStep);
        }
    }
};
...
window.validateStep = validateStep;
console.log('? FunÁıes expostas no escopo global - validateStep:', typeof window.validateStep);
window.initMap = initMap;
...
// Verificar se as funÁıes foram exportadas
console.log('criaevento.js carregado. nextStep disponÌvel:', typeof window.nextStep);

// FunÁ„o de debug para testar manualmente
window.debugWizardCookie = function() {
    ...
    console.log('customDialog disponÌvel?', window.customDialog ? 'SIM' : 'N√O');
    console.log('checkAndRestoreWizardData disponÌvel?', window.checkAndRestoreWizardData ? 'SIM' : 'N√O');
};

// FunÁ„o para limpar cookie corrompido
window.limparCookieCorrempido = function() {
    console.log('Limpando cookie corrompido...');
    deleteCookie('eventoWizard');
    console.log('Cookie limpo! Recarregue a p·gina e tente novamente.');
};
...
// Adicionar salvamento autom·tico ao mudar de step (AP”S funÁıes serem expostas)
if (window.nextStep && window.saveWizardData) {
    ...
    console.error('N„o foi possÌvel configurar override de nextStep - funÁıes n„o encontradas');
    
    console.log('? criaevento.js carregado completamente! nextStep disponÌvel:', typeof window.nextStep);
