...
(function() {
        ...
        const tentarInterceptar = setInterval(() => {
            ...
            if (window.nextStep) {
                ...
                window.nextStep = function() {
                    ...
                    localStorage.setItem('wizardDataCollector', dadosParaSalvar);
    ...
    function recuperarDadosSalvos() {
        const dadosSalvos = localStorage.getItem('wizardDataCollector');
        if (dadosSalvos) {
            try {
