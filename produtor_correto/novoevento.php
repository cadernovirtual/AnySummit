...
<body>
    ...
    <!-- ==================== FIM DOS MODAIS DE LOTES ==================== -->
     ...
     <script language='javascript' src="/produtor/js/correcao-definitiva-total.js?v=<?php echo time(); ?>"></script>
     <!-- CORREÇÃO TOTAL V2 - RESOLVE TUDO -->
     <!-- <script language='javascript' src="/produtor/js/correcao-total-v2.js?v=<?php echo time(); ?>"></script> DESABILITADO: Interferindo com dialogs -->
     ...
     <!-- Sistema unificado de recuperação - DEVE VIR ANTES DOS OUTROS -->
     <script language='javascript' src="/produtor/js/wizard-interceptor/unified-recovery.js?v=<?php echo time(); ?>"></script>
...
<!-- <script src="js/cookie-monitor.js?v=<?php echo time(); ?>"></script> DESABILITADO: Poluindo console -->
...
<script src="js/correcao-cookies-recuperacao.js?v=<?php echo time(); ?>"></script>
...
<script src="js/wizard-interceptor/fix-captura-combo.js?v=<?php echo time(); ?>"></script>
<script src="js/wizard-interceptor/recuperacao-completa-v3.js?v=<?php echo time(); ?>"></script>
<script src="js/wizard-interceptor/fix-conteudo-combo.js?v=<?php echo time(); ?>"></script>
<script src="js/wizard-interceptor/monitor-combos.js?v=<?php echo time(); ?>"></script>
<script src="js/wizard-interceptor/fix-definitivo-coleta.js?v=<?php echo time(); ?>"></script>
<script src="js/wizard-interceptor/monitor-persistencia.js?v=<?php echo time(); ?>"></script>
<script src="js/wizard-interceptor/bridge-persistencia.js?v=<?php echo time(); ?>"></script>
<script src="js/wizard-interceptor/fix-urgente-salvamento.js?v=<?php echo time(); ?>"></script>
<script src="js/wizard-interceptor/nextstep-debug.js?v=<?php echo time(); ?>"></script>
<script src="js/wizard-interceptor/complete-cleanup.js?v=<?php echo time(); ?>"></script>
<script src="js/wizard-interceptor/wizard-data-collector.js?v=<?php echo time(); ?>"></script>
<script src="js/wizard-interceptor/image-url-collector.js?v=<?php echo time(); ?>"></script>
<script src="js/wizard-interceptor/debug-helper.js?v=<?php echo time(); ?>"></script>
<script src="js/wizard-interceptor/restore-improvements.js?v=<?php echo time(); ?>"></script>
<script src="js/wizard-interceptor/ticket-persistence-fix.js?v=<?php echo time(); ?>"></script>
<script src="js/wizard-interceptor/test-helper.js?v=<?php echo time(); ?>"></script>
</body>
</html>