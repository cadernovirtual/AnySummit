...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Executar sincronização apenas uma vez no carregamento
    setTimeout(() => {
        sincronizarIdsAposSalvamento();
    }, 2000);
    
    // Disponibilizar função globalmente para debug manual se necessário
    window.sincronizarIdsAposSalvamento = sincronizarIdsAposSalvamento;
