...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.removeTicket = function(ticketId) {
        console.log(`🗑️ [PADRONIZADO] Removendo ingresso: ${ticketId}`);
    ...
    function preencherModalCombo(ingresso) {
        const campos = {
            ...
            'editComboTicketTitle': ingresso.titulo,
            'editComboTicketDescription': ingresso.descricao || '',
            'editComboTicketPrice': formatarMoeda(ingresso.preco),
    ...
    // Executar padronização periodicamente para capturar novos elementos
    setInterval(() => {
        padronizarBotoesExistentes();
    }, 5000);
    
    console.log('✅ Padronização definitiva configurada');
});
