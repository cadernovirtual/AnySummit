                            ...
                            <div class="lote-section">
                                ...
                                <div class="controle-limite-vendas" style="margin-bottom: 20px; padding: 15px; border-radius: 8px; border-left: 4px solid #007bff;">
                                    <div style="display: flex; align-items: center; margin-bottom: 10px;">
                                        <input type="checkbox" id="controlarLimiteVendas" onclick="toggleLimiteVendas(event)" style="margin-right: 8px;">
                                        <label for="controlarLimiteVendas" style="font-weight: 500; margin: 0;">
...
<!-- SISTEMA INGRESSOS ETAPA 6 CORRIGIDO -->
...
<!-- CORREÇÃO FINAL DOS PROBLEMAS DE LOTES POR PERCENTUAL -->
<script src="js/correcao-lotes-percentual-final.js?v=<?php echo time(); ?>"></script>

<!-- INTERCEPTADOR PARA SALVAMENTO IMEDIATO DE LOTES -->
...
<!-- CORREÇÃO FINAL DEFINITIVA - RESOLVE EXCLUSÃO MYSQL E BOTÕES -->
...
<!-- CORREÇÃO AGRESSIVA - SOBRESCREVE TUDO (ÚLTIMO SCRIPT) -->
...
<!-- CORREÇÃO ESPECÍFICA - LOTES PERCENTUAL -->
...
<!-- CORREÇÃO CONSERVADORA - CONVERTE IDs TEMPORÁRIOS EXISTENTES -->
