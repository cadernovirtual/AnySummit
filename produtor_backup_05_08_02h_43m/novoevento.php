...
if ($evento_id > 0) {
    $sql_evento = "SELECT controlar_limite_vendas, limite_vendas, status, termos_aceitos FROM eventos WHERE id = ? AND usuario_id = ?";
...
<head>
    ...
    <script>
        ...
        window.dadosEvento = {
            ...
            termosAceitos: <?php echo json_encode($dados_evento ? intval($dados_evento['termos_aceitos']) : 0); ?>
        };
...
<!-- <script src="js/correcao-problemas-especificos-etapa6.js?v=<?php echo time(); ?>"></script> DESABILITADO: Conflitos de declaração -->
...
<!-- <script src="js/dom-espelho-mysql-etapa6.js?v=<?php echo time(); ?>"></script> DESABILITADO: JSON malformado -->
...
<!-- CORREÇÃO DEFINITIVA: CHECKBOX DOS TERMOS NA ETAPA 8 -->
<script src="js/correcao-checkbox-termos.js?v=<?php echo time(); ?>"></script>

<!-- PATCH: VALIDAÇÃO CONSISTENTE DA ETAPA 8 -->
<script src="js/patch-validacao-etapa8.js?v=<?php echo time(); ?>"></script>

<!-- DEBUG SIMPLES TEMPORÁRIO: Verificar se botões de lote funcionam -->
<script src="js/debug-simples-lotes.js?v=<?php echo time(); ?>"></script>
