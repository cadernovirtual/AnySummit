...
<head>
    ...
    <title>Entrar - Anysummit</title>
     <link rel="stylesheet" type="text/css" href="/produtor/css/css.css">
</head>
<body>
    ...
    <div class="login-container">
        <div class="logo-section">
           <img src="img/logover.png" style="width:100%; max-width:200px;">
            <p class="subtitle">Entre na sua conta de Produtor</p>
        </div>
        ...
        <div class="signup-link">
            Não possui uma conta? <a href="novo-cadastro.php"><strong>Cadastre-se</strong></a>
        </div>
    </div>
