...
setTimeout(() => {
    ...
    /**
     * Função nextStep SIMPLES - valida, salva e avança
     */
    window.nextStep = async function() {
        ...
        try {
            ...
            // ADICIONAR: Salvar dados da etapa atual antes de avançar
            if (typeof window.salvarEtapaAtual === 'function') {
                console.log(`💾 Salvando dados da etapa ${currentStep}...`);
                window.salvarEtapaAtual(currentStep);
            } else if (typeof salvarEtapaAtual === 'function') {
                console.log(`💾 Salvando dados da etapa ${currentStep}...`);
