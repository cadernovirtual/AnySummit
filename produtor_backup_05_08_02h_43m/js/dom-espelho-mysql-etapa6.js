...
window.recarregarIngressosDoMySQL = async function() {
    ...
    // CORREÇÃO: Verificar se recarregamento está bloqueado (durante exclusão)
    if (window.recarregamentoBloqueado) {
        console.log('🚫 Recarregamento bloqueado temporariamente');
        return;
    }
