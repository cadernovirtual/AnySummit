...
<body>
    ...
    <script>
        ...
        function selectPayment(method) {
            ...
            if (valorOriginal < 5) {
                alert('O valor mínimo para pagamento é R$ 5,00');
                return;
            }
            
            // Se valor menor que R$ 15,00 e tentou selecionar PIX
            if (valorOriginal < 15 && method === 'pix') {
                alert('PIX está disponível apenas para valores acima de R$ 15,00');
                return;
            }
        ...
        function mostrarTimeoutPagamento(codigoPedido) {
            alert('O processamento do pagamento está demorando mais que o esperado. Você será redirecionado para acompanhar o status.');
            
            if (codigoPedido) {
                // Redirecionar para uma página de status de pagamento
