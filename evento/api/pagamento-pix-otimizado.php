...
try {
    ...
    // ========================================
    // 2. CRIAR COBRANÇA PIX - CONFIGURAÇÃO OTIMIZADA
    // ========================================
    ...
    // CONFIGURAÇÃO OTIMIZADA PARA PIX IMEDIATO
    $paymentData = [
        ...
        // CONFIGURAÇÕES ESSENCIAIS PARA PIX FUNCIONAR
        'notificationDisabled' => false,   // CRÍTICO: Manter webhooks ativos
        'postalService' => false,          // Não enviar pelos correios
        
        // Remover configurações que podem interferir
        // Sem fine, interest ou discount para PIX imediato
    ];
    
    error_log('Dados do pagamento PIX OTIMIZADO: ' . print_r($paymentData, true));
    ...
    // ========================================
    // 5. RESPOSTA COM MAIS INFORMAÇÕES
    // ========================================
