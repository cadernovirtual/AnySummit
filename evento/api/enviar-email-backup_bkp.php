 ...
 * Usado como fallback quando o sistema principal não consegue enviar
 */
...
try {
    ...
    // Log do envio
    error_log("Email de ingresso enviado com sucesso via API backup - Destinatário: $destinatario_email - Hash: " . substr($hash_validacao, 0, 10) . "...");
