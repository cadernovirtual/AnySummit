...
<head>
    ...
    <meta property="og:description" content="<?php echo htmlspecialchars(substr($evento['descricao'], 0, 160)); ?>">
...
<body>
    ...
    <footer class="bg-dark text-white py-4 mt-5">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5><?php echo htmlspecialchars($nome_produtor_display); ?></h5>
                    <?php if (!empty($evento['email_contato'])): ?>
                        <p class="mb-1">
                            <i class="fas fa-envelope me-2"></i>
                            <a href="mailto:<?php echo htmlspecialchars($evento['email_contato']); ?>" class="text-white text-decoration-none">
                                <?php echo htmlspecialchars($evento['email_contato']); ?>
                            </a>
                        </p>
                    <?php endif; ?>
                ...
                <div class="col-md-6 text-md-end">
                    ...
                    <p class="mb-1"><?php echo htmlspecialchars($evento['nome']); ?></p>
                    <p class="mb-1">
                        <?php if ($mesmo_dia): ?>
                            <?php echo $data_inicio['data']; ?> • <?php echo $data_inicio['hora']; ?>h às <?php echo $data_fim['hora']; ?>h
                        <?php else: ?>
                            <?php echo $data_inicio['data']; ?> às <?php echo $data_fim['data']; ?>
                        <?php endif; ?>
                    </p>
                    <p class="mb-1">
                        <?php 
                        if ($evento['tipo_local'] == 'online') {
                            ...
                            echo htmlspecialchars($endereco_completo ?: 'Local a ser divulgado');
                        }
                        ?>
                    </p>
                </div>
            ...
            <div class="text-center">
                <small class="text-white">&copy; <?php echo date('Y'); ?> <?php echo htmlspecialchars($nome_produtor_display); ?>. Todos os direitos reservados.</small>
            </div>
        </div>
    </footer>
