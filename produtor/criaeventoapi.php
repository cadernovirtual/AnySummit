...
class AnysummitAPI {
    ...
    public function __construct() {
        ...
        // Criar diretório de uploads com caminho absoluto
   ...
   private function salvarEvento($dados) {
    ...
    private function processarImagem($imagemBase64) {
        ...
        try {
            ...
            $fullPath = __DIR__ . '/' . $this->uploadDir . $filename;
...
";
        ...
        $params = [
            'contratante_id' => $_COOKIE['contratanteid'], // ou verificar se existe
    'usuario_id' => $_COOKIE['usuarioid'], // ou verificar se existe  
    ...
    try {
        ...
        $sql1 = "
            INSERT INTO ingressos (
                ...
                quantidade_total, preco, disponibilidade, ativo, posicao_ordem, conteudo_combo, criado_em
            ) VALUES (
                :evento_id, :tipo, :titulo, :descricao,
                :quantidade_total, :preco, :disponibilidade, :ativo, :posicao_ordem, :conteudo_combo, NOW()
            )
        ";
        ...
        $params1 = [
            ...
            'conteudo_combo' => isset($ingresso['conteudo_combo']) ? json_encode($ingresso['conteudo_combo']) : null
        ];
