...
<script src="js/force-step1-fix.js?v=<?php echo time(); ?>"></script>
...
<script src="js/debug-lotes.js?v=<?php echo time(); ?>"></script>
...
<script src="js/fix-edicao-definitivo.js?v=<?php echo time(); ?>"></script>
<script src="js/fix-funcoes-edicao.js?v=<?php echo time(); ?>"></script>
...
<script src="js/correcao-ids-edicao.js?v=<?php echo time(); ?>"></script>
</body>
</html>