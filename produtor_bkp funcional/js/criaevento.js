...
(function() {
    ...
    let currentStep = 1;
    console.log('🔍 currentStep inicializado como:', currentStep);
    const totalSteps = 8;
    let map;
    let geocoder;
    let marker;
    ...
    let uploadedImages = { logo: '', capa: '', fundo: '' }; // Adicionar esta linha
        ...
        function updateStepDisplay() {
            console.log('📊 updateStepDisplay chamado - currentStep:', currentStep);
        ...
        function validateStep(stepNumber) {
            ...
            switch(stepNumber) {
                ...
                case 5:
                    ...
                    // Verificar window.lotesData ao invés do DOM
...
window.nextStep = function() {
    ...
    if (validateStep(currentStep)) {
        if (currentStep < totalSteps) {
            ...
            updateStepDisplay();
            console.log('? Avan�ou para step:', currentStep);
        }
    }
};
